...
// newHetznerCloudProvider create cloud provider
...
func (cp *hetznerCloudProvider) Name() string {
	return cloudprovider.HetznerProviderName
}

// NodeGroups returns all node groups configured for this cloud provider.
func (cp *hetznerCloudProvider) NodeGroups() []cloudprovider.NodeGroup {
	nodeGroups := make([]cloudprovider.NodeGroup, len(cp.manager.nodeGroups))
	for i, ng := range cp.manager.nodeGroups {
		nodeGroups[i] = ng
	}
	return nodeGroups
}
...
func (cp *hetznerCloudProvider) NodeGroupForNode(node *apiv1.Node) (cloudprovider.NodeGroup, error) {
...
func (cp *hetznerCloudProvider) Pricing() (cloudprovider.PricingModel, errors.AutoscalerError) {
...
func (cp *hetznerCloudProvider) GetAvailableMachineTypes() ([]string, error) {
	return []string{}, nil
}
...
func (cp *hetznerCloudProvider) NewNodeGroup(
	machineType string,
...
func (cp *hetznerCloudProvider) GetResourceLimiter() (*cloudprovider.ResourceLimiter, error) {
	return cp.resourceLimiter, nil
}

// GPULabel returns the label added to nodes with GPU resource.
func (cp *hetznerCloudProvider) GPULabel() string {
	return "not_gpu"
}

// GetAvailableGPUTypes return all available GPU types cloud provider supports.
func (cp *hetznerCloudProvider) GetAvailableGPUTypes() map[string]struct{} {
	return nil
}

// Cleanup cleans up open resources before the cloud provider is destroyed,
// i.e. go routines etc.
func (cp *hetznerCloudProvider) Cleanup() error {
	return nil
}
...
func (cp *hetznerCloudProvider) Refresh() error {
